    ...
    return (
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 h-full bg-base-200 text-base-content">
            ...
            <Link to="/dashboard/employee-notifications" ><li><button className="relative font-medium text-indigo-300 p-1 px-2 before:absolute before:-bottom-1 before:h-0.5 before:w-full before:origin-left before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-100 ">Notifications <span className={badge}></span></button></li></Link>
          </ul>
